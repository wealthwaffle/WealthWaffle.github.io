...
window.WW_Tools = (function() {
  ...
  function traducteurJargon(containerId) {
    ...
    const dico = {
      ...
      // Termes fiscaux belges
      'taeg': { simple:'Taux Annuel Effectif Global — le coût réel total d\'un crédit. Inclut tout : intérêts, frais de dossier, assurance. Toujours comparer les TAEG, jamais les taux nominaux.', exemple:'Un crédit "à 3%" peut avoir un TAEG à 5,2% une fois tous les frais inclus.' },
      'ipp': { simple:'Impôt des Personnes Physiques — l\'impôt sur le revenu en Belgique. Barème progressif de 25% à 50% selon les tranches de revenus.', exemple:'En Belgique, dès 48.320 € de revenus nets imposables, tu paies 50% d\'impôt sur chaque euro supplémentaire.' },
      'plci': { simple:'Pension Libre Complémentaire pour Indépendants. Cotiser via une compagnie d\'assurance ou un fonds de pension pour se constituer une retraite complémentaire. Déductible fiscalement à 100%.', exemple:'Un indépendant peut déduire jusqu\'à 8,17% de son revenu net (max 3.965 €/an) via la PLCI.' },
      'vvprbis': { simple:'Régime permettant aux PME belges de distribuer des dividendes à un précompte réduit de 15% (au lieu de 30%) si les conditions sont respectées.', exemple:'Startup fondée en 2022 : dividende de 10.000 € → PM 15% = 1.500 € retenus. PM classique aurait coûté 3.000 €.' },
      'tax shelter': { simple:'Mécanisme belge d\'avantage fiscal. Deux types : Startups (réduction IPP 45% pour particuliers) et Audiovisuel (exonération IS 310% pour sociétés).', exemple:'Investis 10.000 € dans une startup belge agréée → 4.500 € de réduction d\'impôt directe.' },
      'précompte mobilier': { simple:'Impôt belge retenu à la source sur les revenus mobiliers (dividendes, intérêts). Taux standard : 30%. Libératoire — tu ne dois plus rien déclarer ensuite.', exemple:'Dividende brut 1.000 € → PM 30% = 300 € retenus → tu reçois 700 € nets.' },
      // Termes Radar / PE / Equity
      'moat': { simple:'L\'avantage concurrentiel durable d\'une entreprise. Ce qui l\'empêche d\'être facilement copié ou remplacé par un concurrent. Concept popularisé par Warren Buffett.', exemple:'Le réseau de Facebook est un moat : même si tu crées un meilleur réseau social demain, personne n\'est là-bas.' },
      'roic': { simple:'Return on Invested Capital. Le rendement généré par chaque euro investi dans l\'entreprise. Un ROIC élevé signifie que l\'entreprise crée de la valeur efficacement.', exemple:'ROIC 25% : pour 100 € investis dans l\'outil de production, la boîte génère 25 € de bénéfice opérationnel.' },
      'burn rate': { simple:'Le rythme auquel une startup consomme sa trésorerie chaque mois. Un burn rate élevé avec peu de revenus = la startup risque de manquer de cash (runway court).', exemple:'Cash en banque : 1.200.000 €. Burn rate : 100.000 €/mois. Runway : 12 mois pour trouver des financements.' },
      'arr': { simple:'Annual Recurring Revenue — le montant annuel des revenus récurrents d\'un abonnement ou contrat. La métrique reine des SaaS.', exemple:'100 clients à 99 €/mois = ARR de 118.800 €.' },
      'nrr': { simple:'Net Revenue Retention — mesure si les clients existants dépensent plus ou moins qu\'avant (renouvellements + upsell - churn). NRR > 100% = croissance même sans nouveaux clients.', exemple:'NRR 115% : tes clients existants dépensent 15% de plus qu\'il y a un an. Signe d\'un produit collant.' },
      'cac': { simple:'Coût d\'Acquisition Client — combien coûte en moyenne pour convaincre un nouveau client. À comparer avec la LTV pour vérifier que le modèle économique tient.', exemple:'CAC 500 €, LTV 2.000 € → ratio LTV/CAC de 4x. Acceptable. En dessous de 3x, le modèle est fragile.' },
      'ltv': { simple:'Lifetime Value — la valeur totale qu\'un client génère sur toute la durée de sa relation avec l\'entreprise.', exemple:'Abonnement 49 €/mois, durée moyenne client 24 mois : LTV = 1.176 €.' },
      'equity': { simple:'Le capital d\'une entreprise — les fonds propres. Investir en equity = devenir actionnaire. Rendement potentiel élevé mais risque de perte totale.', exemple:'Tu investis 2.000 € en equity dans une startup. Si elle fait ×5, tu récupères 10.000 €. Si elle fait faillite, tu perds 2.000 €.' },
      'due diligence': { simple:'L\'audit complet d\'un projet avant d\'investir : analyse des finances, de l\'équipe, du marché, des risques. Ce que fait le Radar WealthWaffle automatiquement pour chaque projet.', exemple:'Avant d\'investir 5.000 € dans un projet Spreds, le Radar analyse 14 critères en quelques minutes.' },
